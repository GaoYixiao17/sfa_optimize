...
- 计算公式：
  ...
  > 注：hRes作为可选参数（支持置为nullptr）仅在 <term>Ascend 950PR&950DT系列产品</term> 上支持。
...
<!-- npu="A3,910b" id7 -->
- <term>Atlas A2系列产品</term>、<term>Atlas A3系列产品</term>：参数说明中维度N的取值目前仅支持4，维度D的取值需要128对齐并且取值范围为[1,100000]。
<!-- end id7 -->
<!-- npu="950" id8 -->
- <term>Ascend 950PR&950DT系列产品</term>：参数说明中维度N的取值目前仅支持4、6和8。
