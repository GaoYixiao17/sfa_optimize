...
| PyTorch API | - | 通过[dense_lightning_indexer_kl_loss_grad](../../attention/dense_lightning_indexer_kl_loss_grad/docs/torchapi_dense_lightning_indexer_kl_loss_grad.md)接口调用dense_lightning_indexer_kl_loss_grad算子。 |
