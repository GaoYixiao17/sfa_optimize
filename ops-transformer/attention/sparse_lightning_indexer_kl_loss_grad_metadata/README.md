...
<table style="undefined;table-layout: fixed; width: 1150px"><colgroup>
  ...
  <tbody>
    ...
    <tr>
      <td>topk</td>
      <td>可选属性</td>
      <td>表示从q中筛选出的关键稀疏token的个数，当前支持[1, 2048]和4096、8192。</td>
      <td>INT32</td>
      <td>-</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>max_seqlen_k</td>
      <td>可选属性</td>
      <td>表示k的最长Sequence Length，默认值为0。</td>
      <td>INT32</td>
      <td>-</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>layout_k</td>
      <td>可选属性</td>
      <td>表示k的排列格式，支持BSND、TND，默认值为BSND。</td>
      <td>STRING</td>
      <td>-</td>
    </tr>
    <tr>
...
- B（Batch）表示输入样本批量大小，q为配套的SparseLightningIndexerKLLossGrad算子的入参，S1表示layout_q=BSND时，q shape中的S轴的大小。
...
| PyTorch API | [test_torch_sparse_lightning_indexer_kl_loss_grad_metadata](./examples/test_torch_sparse_lightning_indexer_kl_loss_grad_metadata.py) | 通过[sparse_lightning_indexer_kl_loss_grad_metadata](../../attention/sparse_lightning_indexer_kl_loss_grad/docs/torchapi_sparse_lightning_indexer_kl_loss_grad.md)接口调用SparseLightningIndexerKLLossGradMetadata算子。 |
