...
| PyTorch API | - | 通过[torch.ops.cann_ops_transformer.lightning_indexer](../../attention/lightning_indexer_v2/docs/torchapi_lightning_indexer.md)接口调用LightningIndexerV2算子。|
