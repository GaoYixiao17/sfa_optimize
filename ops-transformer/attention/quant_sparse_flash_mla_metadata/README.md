...
<table style="undefined;table-layout: fixed; width: 1150px"><colgroup>
  ...
  <tbody>
    ...
    <tr>
      <td>quant_mode</td>
      <td>属性</td>
      <td>表示量化模式，1表示Q、K、V 为per-tensor量化，Q、K、V类型为HIFLOAT8。</td>
      <td>INT32</td>
      <td>-</td>
    </tr>
    <tr>
...
- QuantSparseFlashMlaMetadata算子需要与QuantSparseFlashMla算子配套使用。
- B（Batch）表示输入样本批量大小。
