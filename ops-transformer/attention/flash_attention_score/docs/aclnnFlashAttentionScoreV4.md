  ...
  <table style="undefined;table-layout: fixed; width: 1573px"><colgroup>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>如果开启内部生成dropmask，需要传入该参数，否则内部生成dropmask时使用默认值：seed=0。</td>
        <td>INT64</td>
        <td>-</td>
        <td>-</td>
        <td>-</td>
      ...
      <tr>
        ...
        <td>如果开启内部生成dropmask，需要传入该参数，否则内部生成dropmask时使用默认值：offset=0。</td>
        <td>INT64</td>
        <td>-</td>
        <td>-</td>
        <td>-</td>
...
int main() {
  ...
  PrintOutResultFp16(attentionOutShape, &attentionOutDeviceAddr);
