...
- **参数说明**
  ...
  <ul>
    <!-- npu="A3" id7 -->
    <li><term>Atlas A3系列产品</term> ：不支持sequsedQOptional、cmpTopkLengthOptional，numHeadsQ/numHeadsKv仅支持1、2、4、8、16、32、64、128；SWA稀疏ori_kv场景支持oriTopkLengthOptional、oriTopk大于0及oriMaskMode为0，oriWinLeft和oriWinRight支持非负数；其他SWA场景oriTopk为0、oriMaskMode为4、oriWinLeft为127、oriWinRight为0；cmpTopk支持[0, 8192]，其中0表示非稀疏压缩KV，cmpMaskMode仅支持3，cmpRatio仅支持1、4、128。</li>
    <!-- end id7 -->
    <!-- npu="910b" id8 -->
    <li><term>Atlas A2系列产品</term> ：不支持sequsedQOptional、cmpTopkLengthOptional，numHeadsQ/numHeadsKv仅支持1、2、4、8、16、32、64、128；SWA稀疏ori_kv场景支持oriTopkLengthOptional、oriTopk大于0及oriMaskMode为0，oriWinLeft和oriWinRight支持非负数；其他SWA场景oriTopk为0、oriMaskMode为4、oriWinLeft为127、oriWinRight为0；cmpTopk支持[0, 8192]，其中0表示非稀疏压缩KV，cmpMaskMode仅支持3，cmpRatio仅支持1、4、128。</li>
    <!-- end id8 -->
  </ul>
