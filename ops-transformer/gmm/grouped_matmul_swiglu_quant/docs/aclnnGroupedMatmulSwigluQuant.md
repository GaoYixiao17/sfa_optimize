...
[📄 查看源码](https://gitcode.com/cann/ops-transformer/tree/9.2.0/gmm/grouped_matmul_swiglu_quant)
      ...
      <tr>
        ...
        <td>
          <ul>
            ...
            <li>A8W4场景：shape支持3或5维，分别对应数据格式ND、FRACTAL_NZ。</li>
            <li>A8W8场景：shape支持5维，数据格式支持FRACTAL_NZ。</li>
          </ul>
        </td>
...
- **参数说明**
  ...
  <table style="undefined;table-layout: fixed;width: 1150px"><colgroup>
    ...
    <tbody>
      ...
      <tr><td>workspaceSize</td><td>输入</td><td>在Device侧申请的workspace大小，由第一段接口aclnnGroupedMatmulSwigluQuantGetWorkspaceSize获取。</td></tr>
