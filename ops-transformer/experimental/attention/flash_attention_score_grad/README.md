...
- 关于数据shape的约束，以inputLayout的BSND、BNSD为例（BSH、SBH下H=N\*D），其中：
  ...
  - D：
      ...
      - Ascend 950PR&950DT系列产品:取值范围为1\~768。
- keepProb的取值范围为(0, 1]。
...
| 调用方式           | 调用样例                                                                                                              | 说明                                                                                                                    |
|----------------|-------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|
| aclnn调用 | [test_aclnn_flash_attention_score_grad_v2](./examples/test_aclnn_flash_attention_score_grad_v2.cpp)                     | 非TND场景，通过V2接口方式调用FlashAttentionGrad算子。                   |
