...
| 调用方式  | 样例代码                                  | 说明                                                     |
| :--------: | :----------------------------------------: | :-------------------------------------------------------: |
| low_latency_dispatch接口 | [moe_distribute_buffer.py](../common/torch_extension/moe_distribute_buffer.py) | 通过[low_latency_dispatch](../common/docs/torchapi_low_latency_dispatch.md)接口方式调用moe_distribute_dispatch_v3算子。 |
