...
- 确定性计算：
  ...
  <!-- npu="910b" id9 -->
  - <term>Atlas A2系列产品</term>：`aclnnQuantMatmulAllReduceV3`默认非确定性实现，支持通过配置`HCCL_DETERMINISTIC`环境变量为true开启确定性计算。
  <!-- end id9 -->
  <!-- npu="950" id10 -->
  - Ascend 950PR&950DT系列产品：`aclnnQuantMatmulAllReduceV3`默认确定性实现。
  <!-- end id10 -->
