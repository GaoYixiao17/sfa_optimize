...
- 新增`commMode`参数，用户根据该参数指定芯片使用的通信引擎。
  ...
  <!-- npu="910b" id12 -->
  - <term>Atlas A2系列产品</term>：支持`aiv`。
  <!-- end id12 -->
  <!-- npu="A3" id13 -->
  - <term>Atlas A3系列产品</term>：支持`aiv`和`ai_cpu`。
  <!-- end id13 -->
  <!-- npu="950" id7 -->
...
- **参数说明**
    ...
    <tr>
        ...
        <td>输入</td>
        <td>指定当前通信类型。</td>
        <td><term>Atlas A2系列产品</term>支持输入"aiv"；<br><term>Atlas A3系列产品</term>支持输入"aiv"和"ai_cpu"；<br><term>Ascend 950DT系列产品</term>支持输入"ai_cpu"和"ccu"。</td>
        <td>STRING</td>
        <td>-</td>
        <td>-</td>
        <td>-</td>
    ...
    <tr>
        ...
        <td>输入</td>
        <td>ep通信域的大小。</td>
        <td><term>Atlas A2系列产品</term>在commMode为"aiv"时支持2、4、8；<br><term>Atlas A3系列产品</term>支持2、4、8、16、32、64、128；<br><term>Ascend 950DT系列产品</term>支持2、4、8、16、32、64。</td>
        <td>INT64</td>
        <td>-</td>
        <td>-</td>
        <td>-</td>
...
- 通信引擎约束：
  ...
  <!-- npu="910b" id14 -->
  - <term>Atlas A2系列产品</term>：支持AIV通信；AIV模式的epWorldSize支持2、4、8。
  <!-- end id14 -->
  <!-- npu="A3" id8 -->
  - <term>Atlas A3系列产品</term>：支持AIV和AICPU通信。
  <!-- end id8 -->
  <!-- npu="950" id9 -->
  - <term>Ascend 950DT系列产品</term>：支持 CCU 通信和 AICPU 通信，CCU 仅支持单机UB域内互联，AI_CPU 可支持跨机 UB 域内互联。
