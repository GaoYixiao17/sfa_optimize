...
[📄 查看源码](https://gitcode.com/cann/ops-transformer/tree/9.2.0/mc2/moe_distribute_combine_add_rms_norm)
...
- **参数说明**
    ...
    <td>Device侧2D Tensor，shape为(A, H)。</td>
    <td>BFLOAT16</td>
    <td>ND</td>
    <td>2</td>
    <td>√</td>
    ...
    <td>输入</td>
    <td>对应<code>aclnnMoeDistributeDispatchV3</code>的<code>expandScales</code>输出，预留参数。</td>
    <td>当前版本不支持，传空指针即可。</td>
    <td>-</td>
    <td>ND</td>
    <td>-</td>
    ...
    <td>输入</td>
    <td>EP域本卡ID。</td>
    <td>取值范围[0, epWorldSize)，同一通信域内不重复。</td>
    <td>INT64</td>
    <td>-</td>
    <td>-</td>
    <td>-</td>
    ...
    <td>输入</td>
    <td>MoE专家数量。</td>
    <td>取值范围(0, 1024]，且满足 <code>moeExpertNum % (epWorldSize - sharedExpertRankNum) = 0</code>。</td>
    <td>INT64</td>
    <td>-</td>
    <td>-</td>
    <td>-</td>
    ...
    <td>输入</td>
    <td>零专家数量。</td>
    <td>取值范围[0, MAX_INT32)，其中MAX_INT32值为2147483647，合法专家ID范围<code>[moeExpertNum, moeExpertNum+zeroExpertNum)</code>。</td>
    <td>INT64</td>
    <td>-</td>
    <td>-</td>
    <td>-</td>
    ...
    <td>输入</td>
    <td>copy专家数量。</td>
    <td>取值范围[0, MAX_INT32)，其中MAX_INT32值为2147483647，合法专家ID范围<code>[moeExpertNum+zeroExpertNum, moeExpertNum+zeroExpertNum+copyExpertNum)</code>。</td>
    <td>INT64</td>
    <td>-</td>
    <td>-</td>
    <td>-</td>
    ...
    <td>输入</td>
    <td>常量专家数量。</td>
    <td>取值范围[0, MAX_INT32)，其中MAX_INT32值为2147483647，合法专家ID范围<code>[moeExpertNum+zeroExpertNum+copyExpertNum, moeExpertNum+zeroExpertNum+copyExpertNum+constExpertNum)</code>。</td>
    <td>INT64</td>
    <td>-</td>
    <td>-</td>
    <td>-</td>
...
- 其他约束：
    ...
    <!-- npu="950,A3" id12 -->
    - <term>Atlas A3系列产品</term>  、<term>Ascend 950DT系列产品</term>：暂不支持动态缩容。

    <!-- end id12 -->

## 调用示例

<term>Atlas A3系列产品</term>  、<term>Ascend 950DT系列产品</term>，调用aclnnMoeDistributeDispatchV3和aclnnMoeDistributeCombineAddRmsNormV2接口，具体编译和执行过程请参考[编译与运行样例](../../../docs/zh/context/compile_and_run_sample.md)。
...
- 示例代码如下，仅供参考
    ...
    int LaunchOneProcessDispatchAndCombine(Args &args)
    {
        ...
        ret = aclnnMoeDistributeCombineAddRmsNormV2GetWorkspaceSize(
            ...
            hcomEpName, EP_WORLD_SIZE, args.epRankId, moeExpertNum, "", 0,
            0, expertShardType, sharedExpertNum, sharedExpertRankNum, globalBS, outDtype, commQuantMode,
