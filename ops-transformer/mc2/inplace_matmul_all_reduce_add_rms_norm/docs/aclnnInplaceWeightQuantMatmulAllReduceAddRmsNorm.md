...
**须知：该接口后续版本会废弃，请使用aclnnWeightQuantMatmulAllReduce和aclnnAddRmsNorm替代本接口。**

[📄 查看源码](https://gitcode.com/cann/ops-transformer/tree/9.2.0/mc2/inplace_matmul_all_reduce_add_rms_norm)
...
- 确定性计算：
  - aclnnInplaceWeightQuantMatmulAllReduceAddRmsNorm默认非确定性实现，支持通过配置`HCCL_DETERMINISTIC`环境变量为true开启确定性计算
