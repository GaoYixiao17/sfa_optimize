...
该算子为[inplace_partial_rotary_mul](../../inplace_partial_rotary_mul/docs/torchapi_inplace_partial_rotary_mul.md)的反向算子，两者参数`r1`、`r2`、`rotary_mode`、`partial_slice`需保持一致。
